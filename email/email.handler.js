...
export const sendVerificationEmail = async (user) => {
    const verificationToken = jwt.sign(
        { sub: user._id, version: user.authMetadata.emailVerification.version },
...
export const sendPasswordResetEmail = async (user) => {
    const restToken = jwt.sign({
        sub: user._id, version: user.authMetadata.passwordReset.version }, // Aggiungi la versione della password
